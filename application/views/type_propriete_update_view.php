    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          ...
          <form method="post" action="<?php echo base_url()?>TypePropriete/update/" id="myform">
            ...
            <div class="col-md-6 sm-12 xs-12 form-group"> 
              ...
              <input type="text" class="form-control"  placeholder="Type de propriété" name="type_propriete" value="<?php echo $get_type_propriete['TYPE_PROPRIETE']?>" >
              <?php echo form_error('type_propriete', '<span class="text-center text-danger">', '</span>'); ?>

            </div>

            <div class="col-md-12 sm-12 xs-12 form-group">
              <input type="hidden" class="form-control"   name="code_type_propriete" value="<?php echo $get_type_propriete['CODE_TYPE_PROPRIETE']?>">
